...
namespace BMS.Models
{
    public class BlobStorageService
    {
        ...
        {
            this.accessKey = "DefaultEndpointsProtocol=https;AccountName=bmsmoviestorage;AccountKey=gzF8YiAOfobkTqP6gnkkRFr1RUZQnXoM1qWhGlKIks73gAaoE8Qu9vNbQkb0TS+e4Mi55zuDBY3s7utS9hcgEQ==;EndpointSuffix=core.windows.net";
        }
